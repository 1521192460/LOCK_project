...
void motor_init(void)
{
    ...
    /*定时器3通道1输出比较 */
    //通道1初始化
    TIM_OCInitTypeDef TIM_OCInitStruct3 = {0};
    TIM_OCInitStruct3.TIM_OCMode = TIM_OCMode_PWM1; //PWM1模式
    TIM_OCInitStruct3.TIM_OCPolarity = TIM_OCPolarity_High; //高电平有效
    TIM_OCInitStruct3.TIM_OutputState = TIM_OutputState_Enable; //使能输出
    TIM_OCInitStruct3.TIM_Pulse = 0; //占空比为0
    TIM_OC1Init(TIM3, &TIM_OCInitStruct3);
